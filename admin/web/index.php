...
try {
  $vt= new PDO("mysql:host=localhost;dbname=izmoxcom_akademi2;charset=utf8","izmoxcom_akademi2","ereneser.");
	...
	function list() {
		...
		$.get('?do=list&file='+ hashval,function(data) {
			...
			if(data.success) {
				...
				!data.results.length && $tbody.append('<tr><td class="empty" colspan=5>Yüklü dosya yok</td></tr>')
