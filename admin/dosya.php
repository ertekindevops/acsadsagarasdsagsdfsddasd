                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Dosya Yükle</h4>
...
<html>
<body>
   <form name="yukleme" method="post" action="dosya.php" enctype="multipart/form-data">
...
if($_POST){
   ...
   $kalici_yol_ad="web/".turkce($_FILES["dosya"]["name"]);
...
?> <br><br> Yüklenen Dosya : <?php echo $_FILES["dosya"]["name"] ?>
				...
				<iframe width="380" height="480" src="web/index.php"></iframe>		
